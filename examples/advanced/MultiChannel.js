...
export default class MultiChannel extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  _publishChannel0 = async () => {
    this._channel1 && await this._channel1.unpublish();
    this._channel0 && await this._channel0.publish();
  };

  _publishChannel1 = async () => {
    this._channel0 && await this._channel0.unpublish();
    this._channel1 && await this._channel1.publish();
  };

  _leaveChannel0 = async () => {
    this._channel0 && await this._channel0.leaveChannel();
  };

  _leaveChannel1 = async () => {
    this._channel1 && await this._channel1.leaveChannel();
  };
