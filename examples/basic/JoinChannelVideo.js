...
export default class JoinChannelAudio extends Component {
  ...
  _addListeners = () => {
    ...
    this._engine && this._engine.addListener('UserJoined', (uid, elapsed) => {
      console.info('UserJoined', uid, elapsed);
      this.setState({ remoteUid: [...this.state.remoteUid, uid] });
    });
    this._engine && this._engine.addListener('UserOffline', (uid, reason) => {
  ...
  _joinChannel = async () => {
    ...
    this._engine && await this._engine.joinChannel(
      config.token,
  ...
  _switchCamera = () => {
    ...
    this._engine && this._engine.switchCamera()
      .then(() => {
